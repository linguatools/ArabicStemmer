...
/**
 * Stems pre-tokenized input using WhitespaceAnalyzer and ArabicStemmer from Lucene.
 * @author peterkolb
 */
public class ArStemPretokAnalyzer extends Analyzer{
    ...
    protected Analyzer.TokenStreamComponents createComponents(String field) {
        ...
        filter = new ArabicStemFilter(filter);
